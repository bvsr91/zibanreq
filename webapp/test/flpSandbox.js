		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "IBAN Request",
									"targetURL": "#comferrerozibanreq-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comferrerozibanreq-display": {
								"semanticObject": "comferrerozibanreq",
								"action": "display",
								"description": "App",
								"title": "IBAN Request",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ferrero.zibanreq",
									"url": sap.ui.require.toUrl("com/ferrero/zibanreq")
								}
							}
						}
					}
